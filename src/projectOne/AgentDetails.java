...
public class AgentDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgentDetails frame = new AgentDetails();
	...
	public AgentDetails(){}
//	final String param
	public AgentDetails(final String param) {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					String query = "select Agent_UserName, Client_UserName,Invoice.InvoiceNumber,CommissionPercent,PaidAmount,DueDate, Paid from Invoice"; 
							query+= " join Payments on Invoice.InvoiceNumber = Payments.InvoiceNumber and Invoice.Agent_UserName like ? and (CommissionPercent >=? and CommissionPercent <=?)";
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				updateAgentFrame UA = new updateAgentFrame(lbl_username.getText());
				UA.setVisible(true);
			}
		});
		...
		btnNewButton.setBounds(424, 21, 89, 23);
